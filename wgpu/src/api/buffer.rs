...
impl Buffer {
    ...
    /// If this buffer is backed by the WebGPU (browser) backend, returns the
    /// backend-specific [`crate::webgpu_backend::WebBuffer`].
    #[cfg(webgpu)]
    pub fn as_webgpu(&self) -> Option<&crate::backend::webgpu::WebBuffer> {
        self.inner.as_webgpu_opt()
    }
}
